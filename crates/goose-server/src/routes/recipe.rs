...
use goose::{recipe_deeplink, recipe_slash_commands};
...
async fn list_recipes(
    ...
    let all_commands = recipe_slash_commands::list_commands();
...
async fn set_recipe_slash_command(
    ...
    match recipe_slash_commands::set_recipe_slash_command(file_path, request.slash_command) {
        Ok(_) => Ok(StatusCode::OK),
        Err(e) => {
