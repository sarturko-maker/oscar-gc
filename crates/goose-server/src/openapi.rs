...
#[openapi(
    paths(
        ...
        super::routes::recipe::scan_recipe_secrets,
    ...
    components(schemas(
        ...
        super::routes::recipe::ScanRecipeSecretsRequest,
        super::routes::recipe::ScanRecipeSecretsResponse,
        goose::recipe::secret_discovery::SecretRequirement,
