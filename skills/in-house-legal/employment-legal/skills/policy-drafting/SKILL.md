...
1. Load `~/.config/oscar/profile.json` → jurisdictional footprint, handbook location.
...
`~/.config/oscar/profile.json` → jurisdictional footprint, handbook location and format.
