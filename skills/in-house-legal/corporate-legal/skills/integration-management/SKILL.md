...
5. Read/write `~/.config/oscar/state/corporate-legal/deals/[code]/integration-tracker.yaml`.
...
Lives at `~/.config/oscar/state/corporate-legal/deals/[code]/integration-tracker.yaml`. Read `deal-context.md` for
...
```
integration-management --init [--deal [code]]
```

### Step 1: Load deal context

Read `~/.config/oscar/state/corporate-legal/deals/[code]/deal-context.md`. If not found: ask for deal code name,
target company, close date, deal lead, and outside counsel. Write to
deal-context.md if it doesn't exist.

Read `~/.config/oscar/state/corporate-legal/deals/[code]/closing-checklist.yaml` if it exists. Any items marked as
...
>   automatically from `~/.config/oscar/state/corporate-legal/deals/[code]/closing-checklist.yaml`
...
Next step: run integration-management --contracts to import the
...
```
integration-management --contracts [--deal [code]]
```
...
```
integration-management --report [--deal [code]]
```
...
```
integration-management --update [--deal [code]]
```
