#!/usr/bin/env bash
# Sprint 28 M4 — visual polish verification.
#
...
echo "[capture-sprint28-m4] starting Xvfb :$DISPLAY_NUM ($SCREEN_GEOMETRY)"
...
if [[ ! -e "/tmp/.X11-unix/X${DISPLAY_NUM}" ]]; then
  echo "[capture-sprint28-m4] Xvfb failed; tail of log:" >&2
...
cd "$REPO_ROOT"
node "ui/desktop/scripts/capture-sprint28-m4.js" "$@"
