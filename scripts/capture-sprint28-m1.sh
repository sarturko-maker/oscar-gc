...
# Drives the packaged binary through 4 deterministic states; pass/fail logged.
#
# Usage:
#   bash scripts/capture-sprint28-m1.sh --out-dir docs/screenshots/sprint-28-m1
set -euo pipefail
...
echo "[capture-sprint28-m1] starting Xvfb :$DISPLAY_NUM ($SCREEN_GEOMETRY)"
...
if [[ ! -e "/tmp/.X11-unix/X${DISPLAY_NUM}" ]]; then
  echo "[capture-sprint28-m1] Xvfb failed; tail of log:" >&2
...
cd "$REPO_ROOT"
node "ui/desktop/scripts/capture-sprint28-m1.js" "$@"
