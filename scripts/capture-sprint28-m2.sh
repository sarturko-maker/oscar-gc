...
echo "[capture-sprint28-m2] starting Xvfb :$DISPLAY_NUM ($SCREEN_GEOMETRY)"
...
if [[ ! -e "/tmp/.X11-unix/X${DISPLAY_NUM}" ]]; then
  echo "[capture-sprint28-m2] Xvfb failed; tail of log:" >&2
...
cd "$REPO_ROOT"
node "ui/desktop/scripts/capture-sprint28-m2.js" "$@"
