...
echo "[capture-sprint29-m6] starting Xvfb :$DISPLAY_NUM ($SCREEN_GEOMETRY)"
...
if [[ ! -e "/tmp/.X11-unix/X${DISPLAY_NUM}" ]]; then
  echo "[capture-sprint29-m6] Xvfb failed; tail of log:" >&2
...
cd "$REPO_ROOT"
node "ui/desktop/scripts/capture-sprint29-m6.js" "$@"
