...
export const scanRecipeSecrets = <ThrowOnError extends boolean = false>(options: Options<ScanRecipeSecretsData, ThrowOnError>) => (options.client ?? client).post<ScanRecipeSecretsResponses, unknown, ThrowOnError>({
